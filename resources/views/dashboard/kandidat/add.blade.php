            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label>Visi</label>
                            <textarea class="form-control  @error('visi') is-invalid @enderror" rows="3" name="visi" pellcheck="false" required></textarea>
                            @error('visi')
                            <div id="validationServer03Feedback" class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Misi</label>
                            <textarea class="form-control  @error('misi') is-invalid @enderror" rows="3" name="misi" spellcheck=" false" required></textarea>
                            @error('misi')
                            <div id="validationServer03Feedback" class="invalid-feedback">
                                {{ $message }}
                            </div>
