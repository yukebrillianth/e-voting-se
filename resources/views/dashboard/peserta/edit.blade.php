...
<div class="row mb-2" id="header">
    <div class="col-sm-6">
        <h1 class="m-0 text-dark">Ubah Data Peserta</h1>
    </div><!-- /.col -->
    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control  @error('visi') is-invalid @enderror" rows="3" id="visi"
                                ...
                                required>{!! old('nama_kandidat') == null ? $data->visi : old('visi') !!}</textarea>
                            @error('visi')
                            <div id="validationServer03Feedback" class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control  @error('misi') is-invalid @enderror" rows="3" id="misi"
                                ...
                                required>{!! old('nama_kandidat') == null ? $data->misi : old('misi') !!}</textarea>
                            @error('misi')
                            <div id="validationServer03Feedback" class="invalid-feedback">
                                {{ $message }}
                            </div>
